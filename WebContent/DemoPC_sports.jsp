...
<body>
	...
	<%
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"SELECT a.* FROM Games a, Genre b, GamesGenre c WHERE a.GameID = c.GameID AND b.GenreID = c.GenreID AND a.Console ='PC' AND b.Genre='Sports'");
	...
	<div class="row" id="content">
		...
		<ul class="breadcrumbs">
			...
			<li><a href="DemoPC_sports.jsp">Sports</a></li>
		</ul>
		</nav>
