...
<body>
	...
	<%
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"SELECT a.* FROM Games a, Genre b, GamesGenre c WHERE a.GameID = c.GameID AND b.GenreID = c.GenreID AND a.Console ='PS4' AND b.Genre='RPG'");
	...
	<div class="row" id="content">
		...
		<ul class="breadcrumbs">
			...
			<li><a href="DemoPS_rpg.jsp">RPG</a></li>
		</ul>
		</nav>
