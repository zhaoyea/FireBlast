...
<body>
	...
	<center>
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">PC Games</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<div class="row">
				<div class="col-lg-12">
					...
					try {
						...
						PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM Games WHERE (GameID LIKE ? OR Name LIKE ? OR ReleaseDate LIKE ?) AND Console LIKE 'PC'");
