...
<body>
	...
	<%
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM Games WHERE Console='PS4' ORDER BY RAND() LIMIT 6");
	...
	<div class="row small-up-2 medium-up-3 large-up-6">
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM Games WHERE Console='XBox' ORDER BY RAND() LIMIT 6");
	...
	<div class="row small-up-2 medium-up-3 large-up-6">
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("SELECT * FROM Games WHERE Console='PC' ORDER BY RAND() LIMIT 6");
	...
	%>
		<div class="column">
			...
			<span class="button hollow tiny"><%=pc.getString("Price")%></span>
			<a href="#" class="button small expanded hollow">Buy</a>
		</div>
		<%
			}
