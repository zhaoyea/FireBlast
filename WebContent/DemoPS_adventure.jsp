...
<body>
	...
	<%
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"SELECT a.* FROM Games a, Genre b, GamesGenre c WHERE a.GameID = c.GameID AND b.GenreID = c.GenreID AND a.Console ='PS4' AND b.Genre='Adventure'");
	...
	<div class="row" id="content">
		...
		<ul class="breadcrumbs">
			...
			<li><a href="DemoPS_adventure.jsp">Adventure</a></li>
		</ul>
		</nav>
		<div class="medium-8 columns">
			<div class="blog-post">
				<%
					while (ps4.next()) {
				%>
				<h3><%=ps4.getString("Name")%><small></small>
				</h3>
				<a
